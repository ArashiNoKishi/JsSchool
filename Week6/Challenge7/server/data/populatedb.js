...
mongodb.connect(url, (err, db) => {
  ...
  fs.readFile('./src/data/library.json', 'utf8', function(err, data) {
      if (err) throw err;
      ...
      library.map((book) => {
        ...
        let info = data.then((response) => {
            ...
            bookInfo = {
                ...
                isbn: localIsbn,
                isLent: library.find((bk) => {
                        return bk.isbn == localIsbn;
                    }).isLent,
                rating: library.find((bk) => {
                        return bk.isbn == localIsbn;
                    }).rating,
                location: library.find((bk) => {
                        return bk.isbn == localIsbn;
                    }).location
            };
        ...
        // fs.readFile('./src/data/users.json', 'utf8', function(err, data) {
        //     if (err) throw err;
